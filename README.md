### Hi there, I'm [Zakaria Bouzouf](https://github.com/ZakariaBouzouf) 👋

I'm a student in university Duisbug-Essen in Germany,i'm passionate about Computer Science, Linux, and Web Development. I'm constantly learning new technologies and improving my skills to build better software.
...
- Contributing to innovative projects involving React and Spring Boot.
- Internships or part-time opportunities in software development, especially in web and backend development.
- Learning and exploring new technologies that challenge my skills and expand my knowledge.

📚 **Currently Learning:**
- Building dynamic web interfaces with **React**, focusing on state management using hooks and the context API.
- Developing RESTful APIs with **Spring Boot**, integrating with databases, and applying security best practices like authentication and authorization.
- Combining React and Spring Boot to create full-stack applications with seamless front-to-backend integration.
